...
if __name__ == "__main__":
    ...
    parser.add_argument('--schmannnet_outpath', type=str, default='ocda_dglstm/scheduled_mann_net')
    parser.add_argument('--mann_checkpoint_file', type=str, default='ocda_dglstm/mann_net/mann_net_exp_001/checkpoints/mann_net_MsCaOu_Ce_epoch01.pt')
    parser.add_argument('--domain_checkpoint_file', type=str, default='ocda_dglstm/domainfactor/domainfactor_net_exp_000/checkpoints/DomainFactorNet_MsCaOu_Ce_9.pt')
    parser.add_argument('--sortidx_for_schedule', type=str, default='ocda_dglstm/domainfactor/domainfactor_net_exp_000/sortidx_for_schedule.npy')
    parser.add_argument('--centroids_path', type=str, default='ocda_dglstm/lstmmot_exp_013')
    parser.add_argument('--norm_domain_factor', type=bool, default=True)

    parser.add_argument('--comments', type=str, default='Scheduling initial ratio 0.5 and full training after 7 epoch. lr 10^-6 no decay (Shift still) and acc thres 0.4 and loss ratio 1:10')
