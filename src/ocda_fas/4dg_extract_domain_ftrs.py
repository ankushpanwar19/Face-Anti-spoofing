...
if __name__ == "__main__":
    ...
    parser.add_argument('--domainfactor_exp_path', type=str, default='ocda_dglstm/domainfactor/domainfactor_net_exp_000/')
    parser.add_argument('--checkpoint_file', type=str, default='checkpoints/DomainFactorNet_MsCaOu_Ce_9.pt')
